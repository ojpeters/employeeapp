var WebSqlStore = function(successCallback, errorCallback) {
    ...
    this.addSampleData = function(tx, employees) {
        var employees = [
				...
				{"id": 16, "firstName": "Joseph", "lastName": "Eze", "title":"Software engineer", "managerId": 1, "city":"Brampton, ON", "cellPhone":"647-485-8554", "officePhone":"570-699-5577", "email":"ojpeters@gmail.com"}
            ];
